...
#undef PREP
    ...
    #define PREP_RECOMPILE_START    if (isNil "forge_client_fnc_recompile") then {forge_client_recompiles = []; forge_client_fnc_recompile = {{call _x} forEach forge_client_recompiles;}}; private _recomp = {
    #define PREP_RECOMPILE_END      }; call _recomp; forge_client_recompiles pushBack _recomp;
#else
